                    ...
                    <div class="inner_section">
                        <div class="row">
                            ...
                            <div class="work_bottom"> <span>Want to know more..</span>
                                ...
                                <a href="{{ route('page', array('aloas' => $page->alias)) }}" class="contact_btn">Contact Us</a>
                            </div>
                        </div>          
                    </div>
                  </div>
        ...
        <div class="col-lg-8 wow fadeInLeft delay-06s">
          <div class="form">
            <form action="{{ route('home') }}" method="post">
                ...
                <textarea class="input-text text-area" name="text" cols="0" rows="0" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;" placeholder="Your Message *" required></textarea>
